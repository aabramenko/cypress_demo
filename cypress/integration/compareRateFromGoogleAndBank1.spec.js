...
describe('google a currency rate and compare with rate from the bank of Canada [1]', () => {

    const currenciesTo = [dict.CURRENCY.USD.name, 
                dict.CURRENCY.EUR.name,
                dict.CURRENCY.RUB.name]
